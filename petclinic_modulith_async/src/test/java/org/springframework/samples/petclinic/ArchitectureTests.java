...
@AnalyzeClasses(packages = { "org.springframework.samples.petclinic.pet", "org.springframework.samples.petclinic.owner",
		"org.springframework.samples.petclinic.visit", "org.springframework.samples.petclinic.vet" })
public class ArchitectureTests {

	@ArchTest
	public static final ArchRule petRule = classes().that()
		.resideInAPackage("..pet..")
		.should()
		.onlyHaveDependentClassesThat()
		.resideInAnyPackage("..pet..", "..owner..", "..visit..");

	@ArchTest
	public static final ArchRule ownerRule = classes().that()
		.resideInAPackage("..owner..")
		.should()
		.onlyHaveDependentClassesThat()
		.resideInAnyPackage("..owner..", "..visit..");

	@ArchTest
	public static final ArchRule visitRule = classes().that()
		.resideInAPackage("..visit..")
		.should()
		.onlyHaveDependentClassesThat()
		.resideInAnyPackage("..owner..", "..pet..", "..visit..");

	@ArchTest
	public static final ArchRule vetRule = noClasses().that()
