...
nonmodular <- read.csv("nonmodular-load-100vus-treated.csv")
modular <- read.csv("modular-load-100vus-treated.csv")
microservices <- read.csv("microservices-load-100vus-treated.csv")
