...
docker tag ${REPOSITORY_PREFIX}/spring-petclinic-owners-service ${REPOSITORY_PREFIX}/spring-petclinic-owners-service:${VERSION}
docker tag ${REPOSITORY_PREFIX}/spring-petclinic-pets-service ${REPOSITORY_PREFIX}/spring-petclinic-pets-service:${VERSION}
