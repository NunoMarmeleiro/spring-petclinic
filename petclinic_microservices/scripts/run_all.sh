...
sleep 20
nohup java -jar spring-petclinic-owners-service/target/*.jar --server.port=8085 --spring.profiles.active=chaos-monkey > target/owners-service.log 2>&1 &
nohup java -jar spring-petclinic-pets-service/target/*.jar --server.port=8086 --spring.profiles.active=chaos-monkey > target/pets-service.log 2>&1 &
